...
#ifdef LIGHT_SHEEN_USED
		vec4 s_reflection_accum = vec4(0.0, 0.0, 0.0, 0.0);
#endif
...
#endif
#ifdef LIGHT_SHEEN_USED
				accum_complete = accum_complete && s_reflection_accum.a >= 1.0;
#endif
				if (accum_complete) {
					break;
				}
...
#ifdef LIGHT_SHEEN_USED
		if (s_reflection_accum.a < 1.0) {
			s_reflection_accum.rgb = s_specular_light * (1.0 - reflection_accum.a) + s_reflection_accum.rgb;
		}
#endif
